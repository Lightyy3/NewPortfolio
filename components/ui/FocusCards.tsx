...
export const Card = React.memo(
  ({
    ...
    <div
      ...
      className={cn(
        "rounded-2xl relative bg-black-100 dark:bg-black-100 overflow-hidden h-48 sm:h-56 md:h-64 w-full transition-all duration-300 ease-out", // Adjusted height for small screens
